...
var app_bootstrap = function bootstrap(crud) {
  ...
  var app = {
    refresh: function refresh(d) {
      return isFunction(d) ? d(params, _refresh) : _refresh(d);
    }
  };
...
/* harmony default export */ var parse = (function (method, _ref) {
    ...
    function open(options) {
      ...
      conf.items.map(function (e) {
        if (e.prop) {
          ...
          form[e.prop] = hooks_form.bind(form[e.prop] !== undefined ? form[e.prop] : clone_deep_default()(e.value), e.hook, form);
        } // 设置 tabs 默认值
  ...
  render: function render(ctx) {
    ...
    var renderForm = function renderForm() {
      ...
      var children = ctx.conf.items.map(function (e) {
        ...
        e._group = isEmpty(ctx.tabActive) || isEmpty(e.group) ? true : e.group === ctx.tabActive; // Flex handler
          ...
          default: function _default() {
            return [e.component && Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])(Object(external_commonjs_vue_commonjs2_vue_root_Vue_["withDirectives"])(Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])(Object(external_commonjs_vue_commonjs2_vue_root_Vue_["resolveComponent"])("el-form-item"), null, null), [[external_commonjs_vue_commonjs2_vue_root_Vue_["vShow"], e._group]]), _objectSpread2({
              ...
              default: function _default() {
                ...
                })]), isBoolean(e.collapse) && Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("div", {
...
/* harmony default export */ var query = (Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
  name: "cl-query",
  props: {
    modelValue: null,
    list: {
...
/* harmony default export */ var table = (Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
  ...
  setup: function setup(props, _ref) {
    ...
    function onRowContextMenu(row, column, event) {
      // 菜单配置
      var cm = isEmpty(props.contextMenu) && !isArray(props.contextMenu) ? crud.table["context-menu"] : props.contextMenu; // 菜单按钮
...
var CRUD = {
  install: function install(app, options) {
    ...
    setTimeout(function () {
      var _app$config$globalPro = app.config.globalProperties,
          $message = _app$config$globalPro.$message,
          $messageBox = _app$config$globalPro.$messageBox; // @ts-ignore

      window.ElMessage = $message; // @ts-ignore

      window.ElMessageBox = $messageBox;
    }, 0);
    return {
      name: "crud"
    };
